...
public class ReportGenerator {
    ...
    private void loginPortal() throws Exception {
        ...
        inputEmail.clear();
        inputEmail.sendKeys(appUtils.decrypt(AppUtils.secretKey,loginCredential.getLoginEmail()));
        ...
        inputPass.clear();
        inputPass.sendKeys(appUtils.decrypt(AppUtils.secretKey,loginCredential.getLoginPass()));
     ...
     * @param publisherName name of publisher for report
     */
    private void openPlacementPublisherByName(String publisherName){
        ...
        for(int i=0;i<rowCount;i++){
            ...
            WebElement anchorTag = driver.findElement(By.cssSelector("div[id='tablebuilder-ui-summary']"))
                    .findElement(By.tagName("table"))
                    .findElement(By.tagName("tbody")).findElements(By.tagName("tr")).get(i)
                    .findElement(By.cssSelector("td[class='non-admin']")).findElement(By.tagName("a"));
    ...
    private void openReport() {
        WebElement reportMenuElement = driver.findElement(By.cssSelector("ul[id='board_links_wrapper']"))
                .findElement(By.cssSelector("li[data-reports]"))
    ...
    private void parsingPartnerRevenueTableData(String publisherName) {
        ...
        List<WebElement> tableRowsElements = driver.findElement(By.cssSelector("div[id='report_container']"))
                .findElement(By.cssSelector("table[id='table1']"))
        ...
        for(int i=1;i<tableRowsElements.size();i++){
            ...
            modal.setEventDate(appUtils.getEventDateByString(columnList.get(0).getText().split(" ")[0]));
        ...
        //Saving Data in File...
        appUtils.saveJsonData(parsedDataModals,"parseData/json/"+propertyFileMap.get(publisherName).getFileName());
        appUtils.saveRedshiftData(parsedDataModals,"parseData/redshift/"+propertyFileMap.get(publisherName).getFileName());
        System.out.println("Finished Extracting Data For "+publisherName+"=================");
    }

    public static void main(String[] args) throws ParseException {
        System.out.println("$1,000.55".replaceAll("[^\\d.]",""));
